...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        if (args[0].startsWith("-i")) {
            printInformationAboutPersone(args, dateFormatPrt);
        }
    }
    public static void createPersone(String[] args, DateFormat df){
        Date date = null;
        try {
    ...
    public static void updatePerson(String[] args, DateFormat df){
    ...
    public static void printInformationAboutPersone(String[] args, DateFormat df){
        int index = Integer.parseInt(args[1]);
        Person person = allPeople.get(index);
